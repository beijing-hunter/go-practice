...
func init() {
	...
	beego.Router("/course/datalist", &controllers.CourseController{}, "Post:DataList")
	...
	//学生信息
	beego.Router("/studentinfo/index", &controllers.StudentInfoController{}, "*:Index")
	beego.Router("/studentinfo/datagrid", &controllers.StudentInfoController{}, "POST:DataGrid")
	beego.Router("/studentinfo/edit/?:id", &controllers.StudentInfoController{}, "Get,Post:Edit")
	beego.Router("/studentinfo/delete", &controllers.StudentInfoController{}, "Post:Delete")

	//学生考勤
	beego.Router("/stukqinfo/index", &controllers.StuKqInfoController{}, "*:Index")
	beego.Router("/stukqinfo/datagrid", &controllers.StuKqInfoController{}, "POST:DataGrid")
	beego.Router("/stukqinfo/dataexport", &controllers.StuKqInfoController{}, "*:DataExport")

	//限时考勤
	beego.Router("/usercourse/index", &controllers.UserCourseController{}, "*:Index")
	beego.Router("/usercourse/datagrid", &controllers.UserCourseController{}, "POST:DataGrid")
	beego.Router("/courselimitedinfo/save", &controllers.CourseLimitedInfoController{}, "POST:Save")

	//wxapi
	beego.Router("/wxapi/stulogin", &controllers.WxApiController{}, "*:Login")
	beego.Router("/wxapi/kqdaka", &controllers.WxApiController{}, "*:KqDaKa")
	beego.Router("/wxapi/todaycourselimited", &controllers.WxApiController{}, "*:TodayCourseLimited")
	beego.Router("/wxapi/stukqrecord", &controllers.WxApiController{}, "*:StuKqRecord")
